...
function date_time(format){
    switch (format) {
        case "date" :
            format_var = sprintf(strftime( "%Y-%m-%d", systime()))
            break
        case "time" :
            format_var = sprintf(strftime( "%H:%M:%S", systime()))
            break
        case "date_time" :
            format_var = sprintf(strftime( "%Y-%m-%d_%H:%M:%S", systime()))
            break
        case "date time" :
            format_var = sprintf(strftime( "%Y-%m-%d %H:%M:%S", systime()))
            break
    }
    return format_var
}
